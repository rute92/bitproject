...
int draw_detections_cv_v3(mat_cv* mat, detection* dets, int num, float thresh, char** names, image** alphabet, int classes, int ext_output, int mode, int target_class, float* xval, float* wval, float* hval)
// end code <--
{
    try {
        cv::Mat *show_img = mat;
